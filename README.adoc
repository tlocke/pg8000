...
pg8000.core.ProgrammingError: {'S': 'ERROR', 'C': '22P02', 'M': 'invalid input syntax for integer: "ALL"', 'F': 'int8.c', 'L': '99', 'R': 'scanint8'}
>>> conn.rollback()
...
==== pg8000.connect(user, host='localhost', source_address=None, unix_sock=None, port=5432, database=None, password=None, ssl_context=None, timeout=None, application_name=None, tcp_keepalive=True)
