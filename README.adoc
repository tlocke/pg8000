...
You might want to use the current user as the the database username:
...
You might ask, why doesn't pg8000 have the current user as a default
username? The thinking follows the second aphorism of the
